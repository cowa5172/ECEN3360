...
#define I2C0_IEN       I2C0 -> IEN
#define I2C0_IF        I2C0 -> IF
#define I2C0_IFC       I2C0 -> IFC
...
#define I2C0_Clear_ACK()   (I2C0_IFC = I2C_IFC_ACK)
#define I2C0_Int_Clear()   (I2C0_IFC = I2C_IFC_ACK)
#define I2C0_Int_Enable()  (I2C0_IEN |= I2C_IEN_ACK | I2C_IEN_RXDATAV)
#define I2C0_Int_Disable() (I2C0_IEN &= !(I2C_IEN_ACK | I2C_IEN_RXDATAV))
 ...
 *
 * description: Waits for valid data to be received
 *
 * arguments: none
 *
 * returns: none
